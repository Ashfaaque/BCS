  ...
  <!-- Header -->
	  ...
	  <form method="post" action="addcustomerprocess.php" enctype="multipart/form-data">
			<table width="883">
				  <tr>
					<td height="31" colspan="3"><h3 id="loginh3" align="Left">Hello <?php echo $_SESSION['firstName']." ".$_SESSION['lastName'];?></h3></td>
                </tr>
				<tr>
				<td width="175" rowspan="5"><img src="images/<?php echo $_SESSION['image'];?>" width="138" height="174"/></td>
                <td width="103"></td><td width="165"></td><td></td><td></td><td></td>
				</tr>
				  <tr>
					  <td height="31">First Name: </td> <td><input type="text" name="firstName" value="<?php echo $_SESSION['firstName']?>"/></td>
					  <td width="5" style="width:10px"></td>
					  <td width="289" height="31">Last Name: </td> <td width="118"><input type="text" name="lastName" value="<?php echo $_SESSION['lastName']?>"/></td>
				  </tr>
				  <tr>
					  <td height="30">Date of Birth: </td> <td height="30"><input type="text" name="dob" value="<?php echo $_SESSION['dob']?>"/></td>
					 <td style="width:10px"></td> <td height="30">Email: </td>
				  ...
				  <tr>
					<td></td><td></td><td></td><td></td><td colspan="2" align="right">
